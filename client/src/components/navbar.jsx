...
const Navbar = () => {
    ...
    useEffect(() => {
      console.log("Updated Credit in Navbar:", credits);
  }, [credits]);
        ...
        {user ?
         <div className='flex item-center gap-2 sm:gap-3'>
           ...
           hover:scale-105 transition-all duration 700 '>
                ...
                <p className='text-xs sm:text-sm font-medium text-gray-600'> Credits left 
                  :{credits}</p>

            </button>
            <p className='text-gray-600 max-sm:hidden pl-4 pt-2 pr-4'>Hi, {user.name}</p>
...
<ul className='list-none m-0 p-2 bg-white rounded-md border text-sm' > 
        ...
        :
         <div className='flex items-center gap-2 sm:gap-5' >
            ...
            <button onClick={()=> {setShowLogin(true); console.log("Login component rendered")
